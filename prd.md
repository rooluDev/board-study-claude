...
- 수정 시 수정일시 자동 갱신
- 검색 조건 유지
- 수정 완료 후 검색조건 상세 페이지로 이동(검색 조건 유지)
...
**URL**: `/board/view?boardId={ID}&검색조건`  
**화면 구성**: 기능에 맞게
...
**URL**: `/board/edit?boardId={ID}&검색조건`  
**화면 구성**: 기능에 맞게
